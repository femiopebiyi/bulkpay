...
export default function Schedules({ onNewSchedule }: Props) {
    ...
    <div className="animate-slide-up">
      ...
      <div className="bg-white border border-bp-border rounded-lg overflow-hidden">
        ...
        <div className="hidden sm:flex items-center px-3 py-2 border-b border-bp-border-light
          ...
          <div className="w-[18%]">Recurrence</div>
          <div className="w-[12%]">Next</div>
          <div className="w-[22%]">Progress</div>
        ...
        {schedules.map((s) => {
          ...
          return (
            <div
              key={s.id}
              className={`flex flex-col sm:flex-row sm:items-center px-3 py-2.5 border-b border-gray-50
                          last:border-b-0 gap-2 sm:gap-0 ${isCancelled ? "opacity-45" : ""}`}
            >
              ...
              <div className="sm:w-[12%] font-mono text-[11px] text-bp-muted">
                {isCancelled ? "—" : s.nextRun}
              </div>
              ...
              <div className="sm:w-[12%]">
                {!isCancelled && (
                  <button
                    ...
                    className="bg-bp-danger text-bp-danger-text text-[11px] px-2.5 py-1 rounded
                               cursor-pointer hover:bg-red-900 transition-colors"
                  >
                    Cancel
                  </button>
                )}
