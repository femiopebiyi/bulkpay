...
export default function Faucet() {
  ...
  return (
    <div className="animate-slide-up">
      ...
      <p className="text-xs text-bp-muted mb-4 mt-0.5">Mint test USDC to your connected wallet for testing BulkPay</p>
      ...
      <div className="bg-white border border-bp-border rounded-lg overflow-hidden">
        <div className="flex items-center px-3 py-2 border-b border-bp-border-light text-[11px] text-bp-hint tracking-wide uppercase">
          <div className="flex-1">Wallet</div><div className="w-[110px]">Amount</div><div className="w-[80px] text-right">When</div>
        </div>
        {mints.map((m, i) => (
